                    ...
                    <form action="{{ route('education.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <x-input id="passing_year" name="passing_year" class="block mt-1 w-full" type="number"/>
                            </div>
                            <div>
                                <x-label for="cgpa_cpa_grade" value="CGPA/CPA/Grade" :required="true" />
                                <x-input id="cgpa_cpa_grade" name="cgpa_cpa_grade" class="block mt-1 w-full" type="text"/>
                            </div>
                            <div>
                            ...
                            <div>
                                <x-label for="percentage_marks" value="Percentage/Marks" :required="true" />
                                <x-input id="percentage_marks" name="percentage_marks" class="block mt-1 w-full" type="text"/>
                            </div>
                            <div>
                                ...
                                <select id="major_subject" name="major_subject" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                    ...
                                    <option value="Biology/Physics/Commerce (In Case of Metric/FSC)">Biology/Physics/Commerce (In Case of Metric/FSC)</option>
                                    <option value="Finance">Finance</option>
                                    <option value="Banking">Banking</option>
                                    <option value="Marketing">Marketing</option>
                                    <option value="Economics">Economics</option>
                                    <option value="Commerce">Commerce</option>
                                    <option value="CS/MCS/MIT">CS/MCS/MIT</option>
                                </select>
                            </div>
                            <div>
                        ...
                        <table class="w-full text-sm text-left text-white dark:text-gray-400">
                            ...
                            @foreach($user->education_degrees->sortBy('passing_year') as $degree)
                                <tr class="bg-white border-b text-black font-bold dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $degree->passing_year }} / {{ $degree->cgpa_cpa_grade }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $degree->division }} - {{ $degree->percentage_marks }}
                                    </td>
                                    <td class="px-6 py-4">
